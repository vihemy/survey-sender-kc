...
class PhoneNumber:
    ...
    def __init__(self, number):
        self.number = number.replace("00", "+", 1)
        self.parsed_number = phonenumbers.parse(self.number, None) if self.number.startswith('+') else None
    ...
    def national_number(self):
        ...
        return self.parsed_number.national_number if self.parsed_number else int(self.number)
    ...
    def country_name(self):
        ...
        return geocoder.country_name_for_number(self.parsed_number, "en") if self.parsed_number else "Denmark"
